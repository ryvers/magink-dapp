...
export const astarFacts: string[] = [
  ...
  `Hey, here's the deal in the world of smart contract wizardry: developing and deploying a smart contract is a breeze compared to the whole onboarding tale for a parachain. You can start by launching a cool proof-of-concept smart contract, testing the waters and seeing if your idea rocks the real world. Once it gains momentum and the need arises for things like lower transaction fees, supercharged execution, or a slick governance setup for your awesome community, that's when you can migrate your smart contract to a dedicated parachain runtime with its own special slot. It's all about taking it step by step, my friend, and unlock your smart contract magic at just the right moment. <a href="https://use.ink/how-it-works" target="_blank">How it works?</a>`,

  `<a href="https://use.ink/ink-vs-solidity" target="_blank">ink! outshines Solidity</a> with its swanky simplicity and sophisticated features. With a seamless integration into the Astar Network and the power of Rust, ink! empowers developers to create secure and elegant smart contracts. Say goodbye to the complexities of Solidity and embrace the swanky charm of ink! for a stylish and efficient smart contract development experience. Welcome to the future of smart contracts, where ink! reigns supreme.`,
